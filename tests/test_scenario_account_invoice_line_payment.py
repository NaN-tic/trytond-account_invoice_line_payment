...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        line.quantity = 10
        line.unit_price = Decimal('40.0')
        self.assertEqual(invoice.untaxed_amount, Decimal('600.00'))
        self.assertEqual(invoice.tax_amount, Decimal('60.00'))
        self.assertEqual(invoice.total_amount, Decimal('660.00'))
        invoice.click('post')
        invoice.reload()
        self.assertEqual(invoice.state, 'posted')
        first_line, second_line = invoice.lines
        self.assertEqual(first_line.payment_amount, Decimal('220.00'))
        ...
        second_line.reload()
        self.assertEqual(second_line.payment_amount, Decimal('0.00'))
        invoice.reload()
        self.assertEqual(invoice.amount_to_pay, Decimal('220.00'))
        ...
        first_line.reload()
        self.assertEqual(first_line.payment_amount, Decimal('100.00'))
        ...
        invoice.reload()
        self.assertEqual(invoice.amount_to_pay, Decimal('0.0'))
        ...
        writeoff = Wizard('account.invoice.line.payment.write-off',
                          [first_payment])
        self.assertEqual(writeoff.form.amount, Decimal('20.00'))
        ...
        invoice.save()
        line, = invoice.lines
        self.assertEqual(line.party, invoice.party)
